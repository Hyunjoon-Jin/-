...
| 관전 | 2D 피치 실시간 관전(분 단위 공·이벤트, 중계 피드) + 하프타임 전술 개입 |
...
| 히스토리 | 명예의 전당(내 구단 우승·최고순위)·역대 시즌·구단별 우승 순위 |
...
(균형/득점/창조/수비/피지컬/골키핑)를 지정해 시즌 성장 방향을 조절하고,
**사기·시즌 출전**을 확인하며, 계약 만료 임박 선수를 **재계약**할 수 있다.
