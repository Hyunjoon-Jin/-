...
const ITEMS: { tab: string; text: string }[] = [
  ...
  { tab: '경기', text: '내 부(1·2부) 리그 진행. "관전"으로 2D 실시간 + 하프타임 개입. 경기 중 부상 발생 시 즉시 교체할지 물어봅니다. 라이벌 구단과의 경기는 "🔥 라이벌전"으로 표시됩니다. 경기 후 가끔 기자 인터뷰가 열려 답변 톤에 따라 사기·이사회 신뢰도가 바뀝니다. 시즌 말 승강.' },
