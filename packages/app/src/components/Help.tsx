...
const ITEMS: { tab: string; text: string }[] = [
  { tab: '대시보드', text: '구단 재정·스쿼드 요약, 보드진 목표·이사회 신뢰도·특별 요구, 지난 시즌 성적. 신뢰도가 바닥나면 경질됩니다.' },
  { tab: '스쿼드', text: '선수 목록. 나이·CA·잠재력·컨디션(🤕 부상)·계약·가치·주급. 선수를 클릭하면 36능력치·파생 전력·고유 특성(★)을 볼 수 있습니다.' },
  { tab: '전술', text: '포메이션·라인업(베스트 XI/슬롯 교체)과 지시 슬라이더. 팀 전력 실시간 확인.' },
  { tab: '경기', text: '내 부(1·2부) 리그 진행. "관전"으로 2D 실시간 + 하프타임 개입. 경기 중 부상 발생 시 즉시 교체할지 물어봅니다. 시즌 말 승강.' },
