...
const ITEMS: { tab: string; text: string }[] = [
  { tab: '대시보드', text: '구단 재정·스쿼드 요약, 보드진 목표·이사회 신뢰도·특별 요구, 지난 시즌 성적, 라이벌 구단 통산 전적(최근 폼). 선수가 은퇴하거나 통산 마일스톤(50/100경기·10/25골 등)을 달성하면 배너가 표시됩니다. 예상 순위와 실제 성적이 크게 다르면 "이변의 시즌"/"실망스러운 시즌" 배너도 뜹니다. 신뢰도가 바닥나면 경질됩니다.' },
  ...
  { tab: '경기', text: '내 부(1·2부) 리그 진행. 시즌 시작 시 언론 예상 순위가 나옵니다. "관전"으로 2D 실시간 + 하프타임 개입. 경기 중 부상 발생 시 즉시 교체할지 물어봅니다. 라이벌 구단과의 경기는 "🔥 라이벌전"으로 표시됩니다. 경기 후 가끔 기자 인터뷰가 열려 답변 톤에 따라 사기·이사회 신뢰도가 바뀝니다. 시즌 말 승강.' },
