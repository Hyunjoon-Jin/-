...
import type { MediaTone } from '@soccer-tycoon/engine';
    ...
    <div className="modal-backdrop">
      <div className="modal media-modal">
        ...
        <div className="media-options">
          {event.options.map((o) => (
            <button key={o.tone} className="btn-ghost media-opt" onClick={() => onRespond(o.tone)}>
              <span className="media-opt-text">{TONE_LABEL[o.tone]}</span>
