...
| **유스 아카데미** | 매 시즌 유망주 배출, 스쿼드 상한 정리. 대시보드에 "🌱 이번 시즌 유스 기대주" 배너로 잠재력순 소개 |
...
| 패키지 | 역할 | 테스트 |
|---|---|---|
| `@soccer-tycoon/engine` | 헤드리스 시뮬레이션 엔진 (경기·경영·이적·협상·성장·컵·통계·스태프·유스·특성·국대·이사회·요구·통산·부상·스카우팅·미디어) | 167 |
| `@soccer-tycoon/app` | Vite + React UI (9개 화면 + 경기 관전) | 47 |
