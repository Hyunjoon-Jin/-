...
| **라이벌 구단** | 게임 시작 시 같은 부에서 평판이 가장 가까운 구단이 라이벌로 고정, 통산 승무패 전적 추적 + 개별 맞대결 기록. 대시보드 카드(최근 5경기 폼)·다음 경기/프리뷰 "🔥 라이벌전" 표시·히스토리에 전적표 |
...
| `@soccer-tycoon/app` | Vite + React UI (9개 화면 + 경기 관전) | 43 |
