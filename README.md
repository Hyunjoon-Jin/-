...
| **감독 계약** | 계약 기간(초기 3시즌)이 만료되면 이사회가 갱신 제안. 1년(안정)/3년(장기 프로젝트 — 신뢰도 크게 상승하지만 목표 순위가 영구적으로 엄격해짐) 중 선택 |
...
| 패키지 | 역할 | 테스트 |
|---|---|---|
| `@soccer-tycoon/engine` | 헤드리스 시뮬레이션 엔진 (경기·경영·이적·협상·성장·컵·통계·스태프·유스·특성·국대·이사회·요구·통산·부상·스카우팅·미디어) | 169 |
